...
extern "C"
void test_link_prediction(bool type_constrain = false, int cnt_head = 0, int cnt_tail = 0) {
    ...
    l_rank /= cnt_head;
    r_rank /= cnt_tail;
    l_reci_rank /= cnt_head;
    r_reci_rank /= cnt_tail;
    ...
    // with filter
    l_filter_rank /= cnt_head;
    r_filter_rank /= cnt_tail;
    l_filter_reci_rank /= cnt_head;
    r_filter_reci_rank /= cnt_tail;
 
    l_filter_tot /= cnt_head;
    l3_filter_tot /= cnt_head;
    l1_filter_tot /= cnt_head;
 
    r_filter_tot /= cnt_tail;
    r3_filter_tot /= cnt_tail;
    r1_filter_tot /= cnt_tail;
